            ...
            <div className="container">
                <main>
                    <div className="py-5 text-center">
                        ...
                        <p className="text-light lead">A continuación podrás agregar un producto al sistema. Recuerda que todos los campos son
                            obligatorios.</p>
                    </div>

                    <div className="row g-5">
                        <div className="col-md-10 col-lg-8">
                            <h4 className="text-light mb-3">Información del producto</h4>
                            <form className="needs-validation" novaldiate="">
                                <div className="row g-3">
                                    <div className="col-sm-6">
                                        <label for="tipoPrenda" className="text-light form-label">Tipo de prenda</label>
                                    ...
                                    <div className="col-sm-6">
                                        <label for="talla" className="text-light form-label">Talla</label>
                                        <select className="form-select" id="tipoPrenda" required="">
                                            <option value="">Choose...</option>
                                            <option>XS</option>
                                            <option>S</option>
                                    ...
                                    <div className="col-12">
                                        <label for="producto" className="text-light form-label">Nombre del producto</label>
                                    ...
                                    <div className="col-12">
                                        <label for="manufactura" className="text-light form-label">Manufactura <span className="text-muted">(Marca o importador del
                                            producto)</span></label>
                                    ...
                                    <div className="col-12">
                                        <label for="descpripcion" className="text-light form-label">Descripción del producto</label>
                                    ...
                                    <div className="col-12">
                                        <label for="precio" className="text-light form-label">Precio del producto</label>
                                        <div className="input-group has-validation">
                                    ...
                                    <div className="col-sm-8 file-loading">
                                        <input id="input-image-product" name="input-image-product" type="file" accept="image/*" onChange={cargarImagen} style={{ display: "none" }} />
                                        <label className="w-20 btn btn-secondary btn-lg" for="input-image-product">Cargar imagen del producto</label>
                                        <img id="output" width="50%" height="auto" alt="" />
                                    </div>
